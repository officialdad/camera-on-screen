...
rem SDK source dirs: honor the build env vars (the CI runner sets these in .env;
rem they point at C:\actions-runner\_sdk\...) and fall back to the dev defaults.
